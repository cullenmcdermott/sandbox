...
func payloadRegistry() map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"TurnStartedPayload":      reflect.TypeOf(TurnStartedPayload{}),
		"TurnCompletedPayload":    reflect.TypeOf(TurnCompletedPayload{}),
		"TurnFailedPayload":       reflect.TypeOf(TurnFailedPayload{}),
		"TurnInterruptedPayload":  reflect.TypeOf(TurnInterruptedPayload{}),
