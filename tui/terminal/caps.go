...
//
// The package is reusable across TUI applications and deliberately free of any
// Bubble Tea / lipgloss dependency: it reads the environment and returns plain
// data + plain strings. Callers decide where in the composed frame to splice the
// (zero-width) control strings. The sandbox dashboard is one consumer;
// cmd/tuikit-demo is a standalone example.
package terminal
